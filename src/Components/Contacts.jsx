function Contacts(){
    ...
    <div className="contact-container">
        ...
        <div className="contact--links" data-aos = "fade-up">
            <p className="text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque corrupti ratione fuga voluptatem optio nihil illum sunt, maiores at neque!</p>
            ...
            <div className="row">
                ...
                <div className="text-2">
                <h3>Email Address</h3>
                <p>mohamedgisimelsied@gmail.com</p>
                </div>
                </div>
