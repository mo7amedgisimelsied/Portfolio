function Frontend(){
    ...
    return(
        ...
        <p>Crafting intuitive user experiences through innovative front-end design and development, showcasing a blend of creativity and technical expertise.</p>
        
        <div className="img--container">
            <img src="src\assets\Group 50.png"/>
        </div>
